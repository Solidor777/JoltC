...
// PlaneShapeSettings
//
// TITAN PATCH (m34 BodyShape::Halfspace, 2026-05-08): wraps JPH's
// PlaneShapeSettings 1:1. The C-side struct carries Normal + Constant
// rather than a Plane wrapper to avoid introducing a new JPC_Plane
// binding for a single use site. Pending upstream PR to
